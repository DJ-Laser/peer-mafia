...
export function Header({ roomCode }: HeaderProps) {
  ...
  return (
    <Card className="flex flex-col sm:flex-row gap-8 sm:gap-0 justify-between">
      <div className="flex justify-center sm:justify-end">
        <div className="hidden md:flex flex-nowrap">
          ...
          <div className="ml-5 mr-2 border border-slate-400" />
        </div>
      ...
      <div className="space-y-0.5 shrink overflow-x-hidden">
        ...
        <p className="text-slate-400 text-center sm:text-right text-sm whitespace-nowrap overflow-x-hidden text-ellipsis">
          {playUrlDisplay}
        </p>
      </div>
    </Card>
